...
public class CustomRetryPolicy implements RetryPolicy {
  private static final Logger LOG = Logger.getLogger(CustomRetryPolicy.class);
  public static final CustomRetryPolicy INSTANCE = new CustomRetryPolicy();

  protected CustomRetryPolicy() {}
  ...
  public RetryDecision onReadTimeout(
      ...
      int nbRetry) {
    if (nbRetry != 5) return RetryDecision.rethrow();
  ...
  public RetryDecision onUnavailable(
      ...
      int aliveReplica,
      int nbRetry) {
    return (nbRetry == 5) ? RetryDecision.tryNextHost(null) : RetryDecision.rethrow();
  }
  ...
  public RetryDecision onRequestError(
    ...
    if (e instanceof TransportException) {
        LOG.info("Retrying for transport Exception");
